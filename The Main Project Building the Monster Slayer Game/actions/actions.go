...
func AtackMonster(isSpecialAttack bool) int {
	...
	dmgValue := generateRandBetwen(minAttackValue, maxAttackValue)
...
func HealPlayer() int {
	...
	healValue := generateRandBetwen(PLAYER_HEAL_MIN_VALUE, PLAYER_HEAL_MAX_VALUE)
...
func generateRandBetwen(min int, max int) int {
